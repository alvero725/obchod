import { MousePointerClick, ListChecks, FileText, Send, School } from 'lucide-react';
...
const steps = [
  ...
  },
  {
    ...
    desc: 'Skontroluj súhrn a odošli. Požiadavka mi príde a dohodneme sa.',
  },
  {
    icon: School,
    title: 'Dohodneme sa v škole',
    desc: 'Pozriem si tvoju požiadavku a dohodneme sa na cene a termíne osobne v škole.',
  },
];
