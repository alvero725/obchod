    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        <ol className="space-y-2 text-sm text-slate-300">
          ...
          <li className="flex gap-2"><span className="font-semibold text-emerald-400">4.</span> Odošli požiadavku cez formulár.</li>
          <li className="flex gap-2"><span className="font-semibold text-emerald-400">5.</span> Požiadavka mi príde.</li>
          <li className="flex gap-2"><span className="font-semibold text-emerald-400">6.</span> Dohodneme sa v škole.</li>
        </ol>
      </div>
      ...
      <div className="mt-8 flex flex-col items-center gap-4">
        <button
          ...
          className="inline-flex items-center gap-2 rounded-xl bg-emerald-500 px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-emerald-500/25 transition-all hover:bg-emerald-400 hover:-translate-y-0.5"
        >
          Pozrieť si služby
        </button>
      </div>
